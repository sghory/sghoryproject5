...
#when it runs, the question is asked. however, when I put in yes, the map does not display. when i put in no, the map does display, but there is no information
